                        ...
                        <div class="signing">
                            ...
                            <div class="signatures">
                                <div class='validationContainer'>
                                    <h3 id="connectionStatus"></h3>
                                    <p id="connectionText" style="">Please check your connection to the eIDAS server.</p>
                                </div>
                                <button type="button" id="validateButton" style="display: inline-block;width: 100px; height: 50px;margin-top:25px;">Verify</button>
                                <div class="signature">
